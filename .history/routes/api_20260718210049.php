...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/2fa/setup', [TwoFactorController::class, 'setup']);      // ← ADD THIS
    Route::post('/2fa/confirm', [TwoFactorController::class, 'confirm']); // ← ADD THIS
    Route::post('/2fa/disable', [TwoFactorController::class, 'disable']); // ← ADD THIS
