...
class CommissionService
{
    ...
    public function calculateForSale(int $saleId): array
    {
        ...
        // Only completed sales earn commission — adjust this value to
        // match whatever your `sales.status` column actually uses.
        if ($sale->status !== 'completed') {
            return [
                'status' => 'skipped',
                'message' => "Sale status is '{$sale->status}', not 'ompleted'. No commission generated.",
            ];
        }
