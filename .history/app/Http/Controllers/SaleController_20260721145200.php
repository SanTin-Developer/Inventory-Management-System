...
class SaleController extends Controller
{
    ...
    public function store(StoreSaleRequest $request)
    {
        ...
        try {
            ...
            // A sale can be created already marked 'Completed' (e.g. a
            // walk-in/POS sale with no separate approval step) — cover
            // that path too, not just the update() transition below.
