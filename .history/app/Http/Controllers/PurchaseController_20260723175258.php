...
class PurchaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $purchases = Purchase::query()
            ->with(['supplier', 'user', 'details.product'])   // ← add this
    ...
    public function store(StorePurchaseRequest $request)
    {
        ...
        try {
            ...
            // now that purchase_id exists, set the real code
            $purchase->purchase_code = 'P-' . $purchase->purchase_id;
            $purchase->save();
    ...
    private function generateUniquePurchaseCode(): string
    {
        ...
        } while (Purchase::where('category_code', $code)->exists());
