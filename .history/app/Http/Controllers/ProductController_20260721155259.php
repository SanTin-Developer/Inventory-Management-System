...
class ProductController extends Controller
{
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        try {
            ...
            // Auto-generate product_code from the product's own ID when
            // the caller didn't supply one (e.g. "P-1132"). Using the ID
            // guarantees uniqueness with no extra lookup or counter table.
