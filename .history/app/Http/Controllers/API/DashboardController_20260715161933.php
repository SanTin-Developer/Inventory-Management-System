...
class DashboardController extends Controller
{
    ...
    private function salesTrend(): array
    {
        $sales = DB::table('vw_sales_summary')
            ->select(DB::raw("TO_CHAR(sale_date, 'Mon DD') as day"), DB::raw('SUM(total_amount) as amount'))
        ...
        $purchases = DB::table('vw_purchase_summary')
            ->select(DB::raw("TO_CHAR(purchase_date, 'Mon DD') as day"), DB::raw('SUM(total_amount) as amount'))
