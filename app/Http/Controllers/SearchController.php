...
class SearchController extends Controller
{
    public function search(Request $request)
    {
        ...
        // PURCHASES confirmed via DESCRIBE PURCHASES: purchase_id,
        // supplier_id, user_id, purchase_date, total_amount, status,
        // created_at, updated_at — supplier_name is NOT stored here,
        // so this needs a join to suppliers (unlike SALES).
