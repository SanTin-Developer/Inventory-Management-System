    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'db.schema' => \Yajra\Oci8\Schema\OracleBuilder::class,
    ...
    override(\config(), map([
            ...
            'database.connections.oracle.driver' => 'string',
            'database.connections.oracle.tns' => 'string',
            'database.connections.oracle.host' => 'string',
            'database.connections.oracle.port' => 'string',
            'database.connections.oracle.database' => 'string',
            'database.connections.oracle.service_name' => 'string',
            'database.connections.oracle.username' => 'string',
            'database.connections.oracle.password' => 'string',
            'database.connections.oracle.charset' => 'string',
            'database.connections.oracle.prefix' => 'string',
            'database.connections.oracle.prefix_schema' => 'string',
            'database.connections.oracle.edition' => 'string',
            'database.connections.oracle.server_version' => 'string',
            'database.connections.oracle.load_balance' => 'string',
            'database.connections.oracle.connect_timeout' => 'string',
            'database.connections.oracle.retry_count' => 'string',
            'database.connections.oracle.retry_delay' => 'string',
            'database.connections.oracle.transport_connect_timeout' => 'string',
            'database.connections.oracle.expire_time' => 'string',
            'database.connections.oracle.max_name_len' => 'integer',
            'database.connections.oracle.dynamic' => 'array',
            'database.connections.oracle.sessionVars.NLS_TIME_FORMAT' => 'string',
            'database.connections.oracle.sessionVars.NLS_DATE_FORMAT' => 'string',
            'database.connections.oracle.sessionVars.NLS_TIMESTAMP_FORMAT' => 'string',
            'database.connections.oracle.sessionVars.NLS_TIMESTAMP_TZ_FORMAT' => 'string',
            'database.connections.oracle.sessionVars.NLS_NUMERIC_CHARACTERS' => 'string',
            ...
            'filesystems.links.D:\InventoryManagementAPI\inventory-management\public\storage' => 'string',
            ...
            'oracle.oracle.driver' => 'string',
            'oracle.oracle.tns' => 'string',
            'oracle.oracle.host' => 'string',
            'oracle.oracle.port' => 'string',
            'oracle.oracle.database' => 'string',
            'oracle.oracle.service_name' => 'string',
            'oracle.oracle.username' => 'string',
            'oracle.oracle.password' => 'string',
            'oracle.oracle.charset' => 'string',
            'oracle.oracle.prefix' => 'string',
            'oracle.oracle.prefix_schema' => 'string',
            'oracle.oracle.edition' => 'string',
            'oracle.oracle.server_version' => 'string',
            'oracle.oracle.load_balance' => 'string',
            'oracle.oracle.connect_timeout' => 'string',
            'oracle.oracle.retry_count' => 'string',
            'oracle.oracle.retry_delay' => 'string',
            'oracle.oracle.transport_connect_timeout' => 'string',
            'oracle.oracle.expire_time' => 'string',
            'oracle.oracle.max_name_len' => 'integer',
            'oracle.oracle.dynamic' => 'array',
            'oracle.oracle.sessionVars.NLS_TIME_FORMAT' => 'string',
            'oracle.oracle.sessionVars.NLS_DATE_FORMAT' => 'string',
            'oracle.oracle.sessionVars.NLS_TIMESTAMP_FORMAT' => 'string',
            'oracle.oracle.sessionVars.NLS_TIMESTAMP_TZ_FORMAT' => 'string',
            'oracle.oracle.sessionVars.NLS_NUMERIC_CHARACTERS' => 'string',
...
'cache.prefix','cache.serializable_classes','database.default','database.connections.oracle.driver','database.connections.oracle.tns',
'database.connections.oracle.host','database.connections.oracle.port','database.connections.oracle.database','database.connections.oracle.service_name','database.connections.oracle.username',
'database.connections.oracle.password','database.connections.oracle.charset','database.connections.oracle.prefix','database.connections.oracle.prefix_schema','database.connections.oracle.edition',
'database.connections.oracle.server_version','database.connections.oracle.load_balance','database.connections.oracle.connect_timeout','database.connections.oracle.retry_count','database.connections.oracle.retry_delay',
'database.connections.oracle.transport_connect_timeout','database.connections.oracle.expire_time','database.connections.oracle.max_name_len','database.connections.oracle.dynamic','database.connections.oracle.sessionVars.NLS_TIME_FORMAT',
'database.connections.oracle.sessionVars.NLS_DATE_FORMAT','database.connections.oracle.sessionVars.NLS_TIMESTAMP_FORMAT','database.connections.oracle.sessionVars.NLS_TIMESTAMP_TZ_FORMAT','database.connections.oracle.sessionVars.NLS_NUMERIC_CHARACTERS','database.connections.sqlite.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\InventoryManagementAPI\\inventory-management\\public\\storage','logging.default',
...
'mail.markdown.paths','mail.markdown.extensions','oracle.oracle.driver','oracle.oracle.tns','oracle.oracle.host',
'oracle.oracle.port','oracle.oracle.database','oracle.oracle.service_name','oracle.oracle.username','oracle.oracle.password',
'oracle.oracle.charset','oracle.oracle.prefix','oracle.oracle.prefix_schema','oracle.oracle.edition','oracle.oracle.server_version',
'oracle.oracle.load_balance','oracle.oracle.connect_timeout','oracle.oracle.retry_count','oracle.oracle.retry_delay','oracle.oracle.transport_connect_timeout',
'oracle.oracle.expire_time','oracle.oracle.max_name_len','oracle.oracle.dynamic','oracle.oracle.sessionVars.NLS_TIME_FORMAT','oracle.oracle.sessionVars.NLS_DATE_FORMAT',
'oracle.oracle.sessionVars.NLS_TIMESTAMP_FORMAT','oracle.oracle.sessionVars.NLS_TIMESTAMP_TZ_FORMAT','oracle.oracle.sessionVars.NLS_NUMERIC_CHARACTERS','queue.default','queue.connections.sync.driver',
...
'signed','throttle','verified','role','can-manage-salary-ranges',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','categories.index','categories.store','categories.show','categories.update',
'categories.destroy','suppliers.index','suppliers.store','suppliers.show','suppliers.update',
'suppliers.destroy','products.index','products.store','products.show',
'products.update','products.destroy','purchases.index','purchases.store',
'purchases.show','purchases.update','purchases.destroy','departments.index','departments.store',
'departments.show','departments.update','departments.destroy','roles.index','roles.store',
'roles.show','roles.update','roles.destroy','customers.index','customers.store',
'customers.show','customers.update','customers.destroy','sales.index',
'sales.store','sales.show','sales.update','sales.destroy','users.index','users.store',
'users.show','users.update','users.destroy','categories.index','categories.create','categories.store','categories.show',
'categories.edit','categories.update','categories.destroy','storage.local','storage.local.upload',);
...
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.InventoryManagementAPI.inventory-management.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'DB_SERVICE_NAME','CLOUDINARY_URL','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
